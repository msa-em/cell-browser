...
Barkley aimed to record one million unique examples of the [cell nucleus](<wiki:Cell_nucleus>) to train artificial intelligence models.
...
However, it was impossible to interpret the embedding to justify this approach.